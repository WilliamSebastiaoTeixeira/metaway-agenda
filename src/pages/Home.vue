<template>
  <q-page padding class="container">
    <div class="row justify-start q-mb-md">
      <span class="text-h6 text-bold text-grey-9">Home</span>
    </div>
...
async function load() {
  try {
    ...
    const dataContatos = await api.contato.pesquisar.post(filter)
    contatos.value = dataContatos.filter((contato) => {
